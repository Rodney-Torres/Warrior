...
//Its first input (AbilityInputTag) is the id for our ability slots. 
//The second param is our icon material
...
// The first param is for the id to identify the icon slot
// The second param is the total cooldown time
// The third param is for resuming our cooldown
